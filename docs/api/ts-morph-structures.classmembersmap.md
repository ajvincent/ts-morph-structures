...
|  [convertTypeMembers(isStatic, typeMembers, map)](./ts-morph-structures.classmembersmap.converttypemembers.md) | <code>static</code> | Creata an array of class members from an array of type members, |
|  [fromClassDeclaration(classDecl)](./ts-morph-structures.classmembersmap.fromclassdeclaration.md) | <code>static</code> | Create a <code>ClassMembersMap</code> from a class declaration. |
|  [getAsKind(kind, isStatic, name)](./ts-morph-structures.classmembersmap.getaskind.md) |  | A typed call to <code>this.get()</code> for a given kind. |
|  [keyFromMember(member)](./ts-morph-structures.classmembersmap.keyfrommember.md) | <code>static</code> | Get a map key from a potential class member. |
