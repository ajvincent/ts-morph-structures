...
|  --- | --- | --- |
|  [(constructor)(name)](./ts-morph-structures.shorthandpropertyassignmentimpl._constructor_.md) |  | Constructs a new instance of the <code>ShorthandPropertyAssignmentImpl</code> class |
...
|  --- | --- | --- |
|  [clone(source)](./ts-morph-structures.shorthandpropertyassignmentimpl.clone.md) | <code>static</code> |  |
