...
import { CodeBlockWriter, Node, SyntaxKind, StructureKind, forEachStructureChild, ConstructorTypeNode, ModuleKind, ScriptTarget, ModuleResolutionKind, Project, Writers } from 'ts-morph';
...
class StructureAndNodeData {
    ...
    #createNodeHashFromStructure(structure) {
        ...
        let localKind = SyntaxKind[StructureKindToSyntaxKindMap$1.get(structure.kind)];
...
var StructureKindToSyntaxKindMap$1 = StructureKindToSyntaxKindMap;
...
function getTypeAugmentedStructure(rootNode, userConsole, assertNoFailures, kind) {
    if (kind !== undefined &&
        StructureKindToSyntaxKindMap$1.get(kind) !== rootNode.getKind()) {
