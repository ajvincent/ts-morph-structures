...
class ArrayNotImplementedCanary implements Omit<Array<unknown>, number> {
  ...
  every<S>(predicate: (value: unknown, index: number, array: unknown[]) => value is S, thisArg?: any): this is S[] {
    throw new Error("Function not implemented.");
  }
  ...
  filter<S>(predicate: (value: unknown, index: number, array: unknown[]) => value is S, thisArg?: any): S[] {
    throw new Error("Function not implemented.");
  }
  ...
  find<S>(predicate: (value: unknown, index: number, obj: unknown[]) => value is S, thisArg?: any): S | undefined {
    throw new Error("Function not implemented.");
  }
  ...
  findLast<S>(predicate: (value: unknown, index: number, array: unknown[]) => value is S, thisArg?: any): S | undefined {
    throw new Error("Function not implemented.");
  }
